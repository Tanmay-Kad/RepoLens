...
export const analyzeRepository = async (req, res) => {
  ...
  try {
    ...
    // ── Step 1: Clone first so real analysis tools have local files ────────────
    ...
    // ── Step 2: Run real analysis on the cloned local path ─────────────────────
    const analysisResult = await performAnalysis(cloneDir);
